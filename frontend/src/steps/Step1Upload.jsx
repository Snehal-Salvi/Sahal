  ...
  return (
    <div className="s1">
      ...
      <div className="s1-right">
        <div className="hero">
          <h1>Animate faces <em>your way</em></h1>
          <p>
            Upload your video and bring every face to life — apply expressive,
            personalised filters to each person exactly how you imagine it.
          </p>
        </div>

        <div
          className="upload-box"
          style={dragging ? { borderColor: "#f472b6", boxShadow: "0 0 32px rgba(244,114,182,0.25)", background: "rgba(244,114,182,0.06)" } : {}}
        ...
        >
          ...
          <h3>{dragging ? "Release to upload" : "Drop your video here"}</h3>
